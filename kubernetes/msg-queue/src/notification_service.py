...
def process_status_update(message):
    ...
    try:
        if order_data['status'] == 'PENDING':
            ...
            """, (order_data['user_id'], order_data['restaurant_id'], order_data['total_price'], order_data['order_date'], order_data['status']))
...
streaming_pull_future = subscriber.subscribe(subscription_path, callback=process_status_update)
