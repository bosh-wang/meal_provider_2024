...
export class ApiService {
  ...
  constructor(private http: HttpClient) {
    this.getrestaurantURL =
      'https://cors-anywhere.herokuapp.com/http://35.224.128.24:80/api/restaurants';
    this.getmenuURL =
      'https://cors-anywhere.herokuapp.com/http://35.224.128.24:80/api/menu';
  ...
  /*getAllRestaurantsWithoutFilter(
    campus_name: campus_request
  ): Observable<AllRestaurant[]> {
    return this.http.post<AllRestaurant[]>(this.getrestaurantURL, campus_name);
  }*/
